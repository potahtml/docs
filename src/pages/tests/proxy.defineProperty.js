...
test(
	...
	expect => {
		...
		expect(calls).toBe(1)
		expect(args).toHaveShape([undefined])
		...
		expect(calls).toBe(2)
		expect(args).toHaveShape([undefined, 3])
	},
)
...
test(
	...
	expect => {
		...
		expect(calls).toBe(1)
		expect(args).toHaveShape([3])

		Object.defineProperty(o, 'fn', {
			value: 123,
		})
		expect(calls).toBe(2)
		expect(args).toHaveShape([3, 123])
	},
)

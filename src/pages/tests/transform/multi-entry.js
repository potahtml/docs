  ...
  async function asyncTest1() {
    ...
    return async () => {
      ...
      return async () => {
        ...
        return async () => {
          return _await17 + '-' + name();
        };
      };
    };
  }
  const asyncTest2 = async () => {
    const _await18 = await 1;
    return async () => {
      _await18;
      return async () => {
        const _await19 = await name();
        return async () => {
          return _await19 + '-' + name();
        };
      };
    };
  };
  async () => {
    const _await20 = await 1;
    return async () => {
      _await20;
      return async () => {
        const _await21 = await name();
        return async () => {
          return _await21 + '-' + name();
        };
      };
    };
  };
  (async function () {
    const _await22 = await 1;
    return async () => {
      _await22;
      return async () => {
        const _await23 = await name();
        return async () => {
          return _await23 + '-' + name();
        };
      };
    };
  })();
}
{
  async function lala() {
    ...
    return async () => {
      console.log(2);
      return async () => {
        const _await24 = await 1;
        return async () => {
          const _await25 = await 2;
          return async () => {
            const x = name(_await24, _await25);
            return async () => {
              return x + '-' + x;
            };
          };

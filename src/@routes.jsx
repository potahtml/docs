		...
		<Route path="/" scroll={['#content']}>
			...
			<Route path="Components/">
				...
				<Route
					...
					params={{ path: 'Linkify' }}
					children={load(
						() => import('./pages/@components/linkify/index.jsx'),
					)}
				/>
				<Route
					path=":path$"
			...
			<Route path="use/">
				...
				<Route
					...
					params={{ path: 'storage' }}
					children={load(
						() => import('./pages/@use/storage/index.jsx'),
					)}
				/>
				...
				<Route
					...
					params={{ path: 'cached' }}
					children={load(
						() => import('./pages/@use/cached/index.jsx'),
					)}
				/>
				...
				<Route
					...
					params={{ path: 'favicon' }}
					children={load(
						() => import('./pages/@use/favicon/index.jsx'),
					)}
				/>
				<Route
					path=":path$"
					params={{ path: 'gamepad' }}
					children={load(
						() => import('./pages/@use/gamepad/index.jsx'),
					)}
				/>
				<Route
					path=":path$"
					params={{ path: 'mouse' }}
					children={load(
						() => import('./pages/@use/mouse/index.jsx'),
					)}
				/>
				<Route
					path=":path$"
					params={{ path: 'overlay' }}
					children={load(
						() => import('./pages/@use/overlay/index.jsx'),
					)}
				/>
				<Route
					path=":path$"
					params={{ path: 'popover' }}
					children={load(
						() => import('./pages/@use/popover/index.jsx'),
					)}
				/>
				<Route
					path=":path$"
					params={{ path: 'recorder' }}
					children={load(
						() => import('./pages/@use/recorder/index.jsx'),
					)}
				/>
				<Route
					path=":path$"
					params={{ path: 'tooltip' }}
					children={load(
						() => import('./pages/@use/tooltip/index.jsx'),
					)}
				/>
				<Route
					path=":path$"
					params={{ path: 'upload' }}
					children={load(
						() => import('./pages/@use/upload/index.jsx'),
					)}
				/>
				<Route
					path=":path$"
					params={{ path: 'browser' }}
					children={load(
						() => import('./pages/@use/browser/index.jsx'),
					)}
				/>
				<Route
					path=":path$"
					params={{ path: 'color' }}
					children={load(
						() => import('./pages/@use/color/index.jsx'),
					)}
				/>
				<Route
					path=":path$"
					params={{ path: 'css' }}
					children={load(
						() => import('./pages/@use/css/index.jsx'),
					)}
				/>
				<Route
					path=":path$"
					params={{ path: 'dom' }}
					children={load(
						() => import('./pages/@use/dom/index.jsx'),
					)}
				/>
				<Route
					path=":path$"
					params={{ path: 'random' }}
					children={load(
						() => import('./pages/@use/random/index.jsx'),
					)}
				/>
				<Route
					path=":path$"
					params={{ path: 'stream' }}
					children={load(
						() => import('./pages/@use/stream/index.jsx'),
					)}
				/>
				<Route
					path=":path$"
					params={{ path: 'string' }}
					children={load(
						() => import('./pages/@use/string/index.jsx'),
					)}
				/>
				<Route
					path=":path$"
					params={{ path: 'test' }}
					children={load(
						() => import('./pages/@use/test/index.jsx'),
					)}
				/>
				<Route
					path=":path$"
					params={{ path: 'url' }}
					children={load(
						() => import('./pages/@use/url/index.jsx'),
					)}
				/>
			</Route>
			...
			<Route path="Reactivity/">
				...
				<Route
					...
					params={{ path: 'owner' }}
					children={load(
						() => import('./pages/@reactivity/owner/index.jsx'),
					)}
				/>
				<Route
					path=":path$"
					params={{ path: 'unwrap' }}
					children={load(
						() => import('./pages/@reactivity/unwrap/index.jsx'),
					)}
				/>

...
desc: Install pota, wire up the Babel preset (or go compiler-less), and ship your first sketch.
---

# Usage

Install pota, wire up the Babel preset (or go compiler-less), and
ship your first sketch. Starter templates live in the
...
The full set of importable subpaths, in one place. Handy as a map
when wiring bundler aliases or vendoring pota. Each `pota/use/*`
module is one subpath per file under `src/use/`.

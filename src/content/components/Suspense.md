...
topic: Async
desc: Shows a fallback until the promises its descendants read have all resolved.
---
...
subtree, even across nested child components — the fallback stays until
the deepest promise settles.

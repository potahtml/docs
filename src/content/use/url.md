...
topic: Routing
desc: Small URL string helpers — protocol/origin checks, a safe decodeURIComponent, and replaceParams.
---
...
- [`encodeURIComponent`](/use/url/encodeURIComponent) — platform
  passthrough
- [`decodeURIComponent(s)`](/use/url/decodeURIComponent) — safe decode,
  never throws

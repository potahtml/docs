...
stopped. Pair it with
[`copyVideoTracks`](/use/stream/copyVideoTracks) to swap a device
live, or use [`stopStream`](/use/stream/stopStream) when you actually
want to release the hardware. Part of

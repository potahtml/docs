...
topic: Browser
desc: Toggle and observe fullscreen — a ref factory plus reactive and imperative forms.
---
...
- [`useFullscreen()`](/use/fullscreen/useFullscreen) — reactive
  signal accessor of the fullscreen element
...
**Returns:** a ref function `(node) => void` for `use:ref` that toggles
fullscreen on click.

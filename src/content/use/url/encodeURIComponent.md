...
topic: Routing
desc: Platform encodeURIComponent, re-exported alongside the safe decoder.
---
...
companion [`decodeURIComponent`](/use/url/decodeURIComponent) is a safe
variant that returns the input instead of throwing. Part of

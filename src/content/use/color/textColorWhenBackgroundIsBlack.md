...
`textColorWhenBackgroundIsBlack(color)` iteratively lightens `color` in
5% steps until it reaches APCA Lc ≥ 60 on a black background, capped at
20 steps, returning the adjusted hex string. For the white-background
companion see
...
Shifts a user-chosen color light enough to stay legible against a black

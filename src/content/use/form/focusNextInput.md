...
topic: Forms
desc: The focus stepper behind enterFocusNext, exported for custom key handlers.
---
...
function App() {
	return (
		<form on:submit={e => e.preventDefault()}>
			<input placeholder="ArrowDown advances" use:ref={arrowAdvances} />
			<input placeholder="ArrowDown advances" use:ref={arrowAdvances} />
			<input placeholder="last field" use:ref={arrowAdvances} />
		</form>
	)
}

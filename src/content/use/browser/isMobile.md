...
`true` when `navigator.userAgent` matches _mobile_, _iphone_,
_ipod_, _ios_, _ipad_, or _android_. It is evaluated once at module
load — a coarse UA guard, not a live signal.

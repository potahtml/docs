...
topic: Internals
desc: Flash every element on each render — a render-thrashing visualiser.
---

# rerenders

`rerenders()` injects a temporary adopted stylesheet that flashes every
element with a blue background whenever it rerenders — a drop-in

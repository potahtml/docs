...
topic: Forms
desc: Form ergonomics — ref functions for input behaviors plus helpers to read and write form state.
---
...
- [`clickFocusChildrenInput`](/use/form/clickFocusChildrenInput) — ref:
  clicking the element focuses its first focusable descendant

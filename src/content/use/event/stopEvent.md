...
topic: Events
desc: Call preventDefault, stopPropagation, and stopImmediatePropagation at once.
---
...
[`stopImmediatePropagation`](/use/event/stopImmediatePropagation) —
in one call. Useful as a one-liner handler body, or composed with
other handlers. Part of [`pota/use/event`](/use/event).

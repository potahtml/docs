...
topic: Events
desc: Low-level DOM event helpers — stop helpers, emit, waitEvent, native listeners.
---
...
options objects. (For JSX events the `on:*` prop is already
idiomatic — reach here for listeners on window / document /

...
of the document element's size — it reads `documentElement.clientWidth`
and `clientHeight` once and does not track. For a reactive accessor
that re-runs effects on every window resize, use
[`useDocumentSize`](/use/resize/useDocumentSize). Part of

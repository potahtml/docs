...
topic: Interaction
desc: Per-element focus ref functions, document focus state, and focus traversal.
---
...
through an emitter
([`useDocumentFocus`](/use/focus/useDocumentFocus) /
[`onDocumentFocus`](/use/focus/onDocumentFocus)) and standalone focus
traversal helpers ([`focusNext`](/use/focus/focusNext) /

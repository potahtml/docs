...
topic: Browser
desc: Scroll to a selector, falling back to the top of the page on a miss.
---
...
[`scrollToTop`](/use/scroll/scrollToTop) when the selector matches nothing.
...
Tries to scroll to a selector that may or may not exist; when it is missing the

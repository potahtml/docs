...
topic: Observers
desc: use:ref factory that lazy-loads an <img> when it enters the viewport.
---
...
enters the viewport, then disconnects the observer. Pass
`rootMargin` to start loading before the image scrolls in. Unlike the
